...
public class Server {
    public static String localhost="http://192.168.0.105";
    ...
    public static String DuongdanLogin= localhost+"/DoAn/login.php";
    public static String DuongDanDangKi=localhost+"/DoAn/register.php";
}
